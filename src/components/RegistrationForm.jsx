...
const RegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const sheetdbUrl = 'https://sheetdb.io/api/v1/5x2nzix6na6kg'; // Replace with your SheetDB API URL
  ...
  return (
    <div className="md:w-[60%] w-[95%] mx-auto h-auto my-20">
      <form onSubmit={handleSubmit} className="w-full">
        ...
        <p className='text-gray font-Inter font-semibold text-center leading-7'>You are registering for our one-month FREE intensive tech and non-tech program designed to equip you with foundational skills in various high-demand fields. This free program serves as an introduction to our comprehensive curriculum, preparing you for real-world projects and career opportunities.</p>
        ...
        <div className='flex flex-col md:flex-row gap-10 mb-6 mt-5'>
            <div className="w-full">
              ...
              <input
                ...
                className="mt-1 p-2 w-full border border-white/15 rounded bg-darkGray text-white outline-none"
                required
              />
            </div>
            ...
            <div className="w-full">
              ...
              <input
                ...
                onChange={handleChange}
                className="mt-1 p-2 w-full border border-white/15 bg-darkGray text-white rounded outline-none"
                required
              />
            </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row gap-10 mb-6'>
            <div className=" w-full">
              ...
              <input
                ...
                onChange={handleChange}
                className="mt-1 p-2 w-full border border-white/15 bg-darkGray rounded text-white outline-none"
                required
              />
            </div>
            ...
            <div className="w-full">
              ...
              <input
                ...
                onChange={handleChange}
                className="mt-1 p-2 w-full border border-white/15 bg-darkGray text-white rounded"
                required
              />
            </div>
        </div>
            ...
            {['Male', 'Female', 'Prefer not to say'].map((option) => (
              <label key={option} className={`${formData.gender === option ? "bg-orange-200":""} block mr-4 border border-white/15 p-2.5 rounded bg-darkGray mb-3 cursor-pointer`}>
                <input
                  ...
                  className="peer"
                />
                <span className="ml-2 text-white peer-checked:text-black">{option}</span>
              </label>
            ))}
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="mt-1">
            {['Secondary School', 'Undergraduate Student', 'Graduate', 'Postgraduate', 'Other'].map((option) => (
            ...
            {[
              ...
              <label key={course} className={`${formData.course === course ? "bg-orange-200":""} block mr-4 border border-white/15 p-2.5 rounded bg-darkGray mb-3 cursor-pointer`}>
                <input
                  ...
                  required
                />
                <span className="ml-2 text-white peer-checked:text-black">{course}</span>
              </label>
            ))}
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <textarea 
            ...
            onChange={handleChange}
            className="mt-1 p-2 w-full border border-white/15 bg-darkGray rounded outline-none text-white">
            </textarea>
        </div>
        ...
        <div className="mb-8">
          ...
          <input
            ...
            onChange={handleChange}
            className="mt-1 p-2 w-full border border-white/15 bg-darkGray rounded"
          />
        </div>
        ...
        <div className="mb-4">
          ...
          <div  className='mt-1'>
              <label className={`${formData.consent ? "bg-orange-200":""} block mr-4 border border-white/15 p-2.5 rounded bg-darkGray mb-3 cursor-pointer`}>
                ...
                />
                <span className="ml-2 text-white peer-checked:text-black">I consent to receive updates via email/WhatsApp.</span>
              </label>
          </div>
        </div>
